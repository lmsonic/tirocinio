    ...
    public class KinematicBody : MonoBehaviour
    {
        ...
        private void HandleCollision()
        {
            if (velocity.sqrMagnitude > MinMoveDistance)
            {
                ...
                lateralVelocity = transform.TransformVector(lateralVelocity);
                verticalVelocity = transform.TransformVector(verticalVelocity);
        ...
        Vector3 topGizmoSphere;
        Vector3 bottomGizmoSphere;
        Vector3 directionGizmoSphere;
        float radiusGizmoSphere;
        float distanceGizmoSphere;
